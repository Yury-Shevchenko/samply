...
app.use((req, res, next) => {
  ...
  res.setHeader('Content-Security-Policy', `worker-src http://localhost https://samply.ml https://www.samply.ml; script-src https://samply.ml https://www.samply.ml 'nonce-${noncevalue}' 'unsafe-eval' `);
