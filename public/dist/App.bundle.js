...
(function (factory) {
  ...
  var _sanitizeAttributes = function _sanitizeAttributes(currentNode) {
    ...
    while (l--) {
      ...
      /* Otherwise, check the name is permitted */else if (!ALLOWED_ATTR[lcName] || FORBID_ATTR[lcName]) {
        continue;
      }
      ...
      /* Check no script, data or unknown possibly unsafe URI
         unless we know URI values are safe for that attribute */else if (IS_ALLOWED_URI.test(value.replace(ATTR_WHITESPACE, ''))) {
        // This attribute is safe
      }
      /* Keep image data URIs alive if src is allowed */else if (lcName === 'src' && value.indexOf('data:') === 0 && DATA_URI_TAGS[currentNode.nodeName.toLowerCase()]) {
        // This attribute is safe
      }
      /* Allow unknown protocols: This provides support for links that
         are handled by protocol handlers which may be unknown ahead of
         time, e.g. fb:, spotify: */else if (ALLOW_UNKNOWN_PROTOCOLS && !IS_SCRIPT_OR_DATA.test(value.replace(ATTR_WHITESPACE, ''))) {
        // This attribute is safe
      }
      /* Check for binary attributes */else if (!value) {
        // binary attributes are safe at this point
      }
      /* Anything else, presume unsafe, do not add it back */else {
        continue;
      }
...
/***/ "./public/javascripts/modules/addTest.js":
/*!***********************************************!*\
  !*** ./public/javascripts/modules/addTest.js ***!
  \***********************************************/
...
function autocomplete(input, latinput, lnginput) {
  ...
  dropdown.addListener('place_changed', function () {
    ...
    displayLocation((0,_bling__WEBPACK_IMPORTED_MODULE_0__.$)('#single_map'), place, latinput, lnginput);
  });
...
function searchResultsHTML(tests) {
  return tests.map(function (test) {
    return "\n      <a href=\"/tests/test/".concat(test.slug, "\" class=\"search__result\">\n        <strong>").concat(test.name, "</strong>\n      </a>\n    ");
  }).join('');
}
function typeAhead(search) {
  ...
  searchInput.on('input', function () {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default().get("/api/search?q=".concat(this.value)).then(function (res) {
      ...
      searchResults.innerHTML = dompurify__WEBPACK_IMPORTED_MODULE_1___default().sanitize("<div class=\"search__result\"> ... </div>");
    }).catch(function (err) {
      console.error(err);
    });
  });
...
/* harmony import */ var _modules_addTest__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/addTest */ "./public/javascripts/modules/addTest.js");




(0,_modules_typeAhead__WEBPACK_IMPORTED_MODULE_2__["default"])((0,_modules_bling__WEBPACK_IMPORTED_MODULE_0__.$)(".search"));
var testForms = (0,_modules_bling__WEBPACK_IMPORTED_MODULE_0__.$$)("form.heart"); // listen to all forms
testForms.on("submit", _modules_addTest__WEBPACK_IMPORTED_MODULE_3__["default"]);
}();
/******/ })()
;
