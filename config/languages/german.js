  ...
  'index' : {
    ...
    'researcher' : {
      ...
      'notifications': {
        ...
        'step_1_current' : 'Aktuelle Teilnehmer',
        'step_1_all': 'Alle',
        'step_2_header' : '1. Zeit auswählen',
        'step_2_timepoints': 'Bestimmte(r) Zeitpunkt(e)',
        'step_2_windows': 'Zeitfenster (der genaue Zeitpunkt (die genauen Zeitpunkte) werden zufällig gewählt)',
        ...
        'step_2_random': 'Wie viele Zeitpunkte sollen aus diesem Zeitfenster zufällig ausgewählt werden?',
        'step_3_header' : '3. Datum(e) auswählen',
        'step_3_dates' : 'Spezifische(s) Datum(e)',
        'step_3_every': 'Jeder',
        'step_3_days': 'Tag(e)',
        'step_3_weekday' : 'Bestimmter Wochentag (wählen Sie einen oder mehrere aus)',
        'step_3_monthday' : 'Bestimmter Tag des Monats (wählen Sie einen oder mehrere aus)',
        'step_3_day' : 'Tag (1 - 31)',
        'step_3_month' : 'Monat (1 - 12)',
        'step_3_yeary' : 'Jahr',
        'step_3_add_date' : 'Ein weiteres Datum hinzufügen',
        'step_4_header' : '4. Monat(e) auswählen',
        'step_4_any' : 'Jeder Monat',
        'step_4_specific' : 'Bestimmter Monat (wählen Sie einen oder mehrere aus)',
        'step_5_header' : '5. Wählen Sie, wann zu beginnen',
        'step_5_timepoint' : 'Start zu einem bestimmten Zeitpunkt',
        ...
        'step_5_registration': 'der Moment der Teilnehmerregistrierung',
        'step_5_now': 'jetzt',
        'step_6_header' : '6. Wählen Sie, wann aufzuhören',
        'step_6_timepoint' : 'An einem bestimmten Zeitpunkt stoppen',
        'step_6_participant' : 'Keine Benachrichtigung mehr für jeden Teilnehmer senden nach',
        ...
        'table_all_participants' : 'Gilt für alle Teilnehmer zum Zeitpunkt der Erstellung der Benachrichtigung',
