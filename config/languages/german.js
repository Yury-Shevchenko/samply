module.exports = {
  ...
  'layout' : {
    ...
    'click_to_unsuscribe': 'Klicken Sie hier, um die Benachrichtigungen über die Studie abzubestellen.',
    'login_with_your_email': 'oder melden Sie sich mit Ihrer E-Mail an',
    'login_to_your_account': 'Anmelden',
    'create_new_account': 'Neues Konto erstellen',
    'already_have_code': 'Wenn Sie Ihren Teilnehmercode bereits kennen, melden Sie sich ',
    'here': 'hier an.',
  ...
  'index' : {
    ...
    'researcher' : {
      ...
      'notifications': {
        ...
        'schedule_explanation_2': 'Wählen Sie das Datum und die Uhrzeit für die zu sendende(n) Benachrichtigung(en). Sie können weitere Zeitpunkte hinzufügen, indem Sie auf die Plus-Schaltfläche klicken.',
        'add': 'Hinzufügen',
        'random_onetime_notifications_info': 'Wählen Sie den Zeitraum, in dem eine Benachrichtigung gesendet werden soll. Der genaue Zeitpunkt der Benachrichtigung wird nach dem Zufallsprinzip gewählt.',
        ...
        'interval_explanation_3': 'Der Zeitraum für Benachrichtigungen',
        ...
        'month': 'Monat',
        'day_week': 'Tag (Woche)',
        'individual_explanation_1': 'Benutzerabhängige Benachrichtigungen funktionieren auf dieselbe Weise wie wiederholte Benachrichtigungen, aber ihr Zeitraum beginnt in dem Moment, in dem ein Teilnehmer die Benachrichtigungen genehmigt.',
        ...
        'table_sending_time': 'Geplante Zeit',
        'table_start_repeat': 'Beginn der Wiederholung',
        'table_start_end': 'Beginn der Wiederholung',
        'table_repeat_interval': 'Wiederholungsintervall',
        'table_user_time_period': 'Benutzerabhängige Zeitspanne',
        'table_user_range' : 'Spannweite von Wiederholungsintervall',


        'delete_notifications': 'Alle Benachrichtigungen löschen',
        'registering_busy_message': 'Registrierung der Benachrichtigung ...',
        'one_time_notifications_to_participant_1':'Einmalige Benachrichtigungen werden nur an den Teilnehmer mit ID ',
        'one_time_notifications_to_participant_2':' vorgesehen.',
        'one_time_notifications_to_all_1':'Einmalige Benachrichtigungen sind für alle Teilnehmer Ihrer Studie ',
        'one_time_notifications_to_all_2':'vorgesehen, die sich registriert und Benachrichtigungen zugelassen haben.',
        'regular_notifications_to_participant_1': 'Regelmäßige Benachrichtigungen werden nur an den Teilnehmer mit ID ',
        'regular_notifications_to_participant_2': ' vorgesehen',
