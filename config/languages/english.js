    ...
    'index' : {
      ...
      'researcher' : {
        ...
        'notifications': {
          ...
          'title': 'Title',
          'message': 'Message',
          'step_1_header' : '1. Choose participants',
          ...
          'step_2_random': 'How many time points should be randomly selected from this time window?',
          'step_3_header' : '3. Choose date(s)',
          'step_3_dates' : 'Specific date(s)',
          'step_3_every': 'Every',
          'step_3_days': 'day(s)',
          'step_3_weekday' : 'Specific day of week (choose one or many)',
          'step_3_monthday' : 'Specific day of month (choose one or many)',
          'step_3_day' : 'Day (1 - 31)',
          'step_3_month' : 'Month (1 - 12)',
          'step_3_yeary' : 'Year',
          'step_3_add_date' : 'Add one more date',
          'step_4_header' : '4. Choose month(s)',
          'step_4_any' : 'Any month',
          'step_4_specific' : 'Specific month (choose one or many)',
          'step_5_header' : '5. Choose when to start',
          ...
          'step_5_now': 'now',
          'step_6_header' : '6. Choose when to stop ',
          ...
          'table_all_participants' : 'Applies to all participants at the moment of notification creation',
