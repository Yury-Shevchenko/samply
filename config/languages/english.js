module.exports =
{
    ...
    'index' : {
      ...
      'tasks' : {
        ...
        'results_table_samplyId': 'Samply ID',
      ...
      'researcher' : {
        ...
        'docs': {
          ...
          'navigation_1': 'After registering as a researcher, you can set up your own study. ' +
          'The navigation menu in the header contains links to the main features.',
          'navigation_1_1': `<a href='../docs/upload'>Tasks</a> Browse available tasks and upload your own task`,
          'navigation_1_2': `<a href='../docs/project'>Studies</a> Set up notifications for your study`,
          'navigation_1_3': `<a href='../docs/data'>Data</a> Review participants and notifications`,
