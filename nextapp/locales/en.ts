...
const en = {
  ...
  docs: {
    ...
    pageEyebrows: {
      ...
      integrations:       "connect your survey tool",
    ...
    pageLedes: {
      ...
      integrations:       "Step-by-step guides for passing the Samply IDs into your survey tool and registering completion with a redirect — Qualtrics, SoSci, LimeSurvey, Unipark, REDCap and more.",
  ...
  analytics: {
    ...
    /** Label for results sent before notificationConfigId was persisted (old rows). */
