...
const INDEX: Entry[] = [
  ...
  { slug: "groups",        label: "Groups",       section: "Power features",         title: "Groups",                               lede: "Groups let you send different schedules to different subsets of participants within the same study." },
  ...
  { slug: "integrations",  label: "Survey integrations",    section: "Integrations",           title: "Survey tool integrations",                       lede: "Guides for Qualtrics, SoSci, LimeSurvey, Unipark, REDCap, SurveyMonkey, Alchemer and QuestionPro — pass the Samply IDs in and register completion with a redirect." },
  { slug: "analytics",     label: "Analytics",              section: "Advanced features",      title: "Analytics — monitoring a study while it runs",   lede: "Compliance, response times, dropout, and per-participant engagement, built around documented threats to ESM validity." },
