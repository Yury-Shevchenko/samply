  ...
  return (
    <main style={{ background: "var(--paper)", minHeight: "100vh", color: "var(--ink)", display: "flex", alignItems: "center", justifyContent: "center" }}>
      <div style={{ maxWidth: "48rem", padding: "4rem", textAlign: "center" }}>
        <div style={{ fontFamily: "var(--font-mono)", fontSize: "1rem", letterSpacing: "0.16em", textTransform: "uppercase", color: "var(--coral)", marginBottom: "1.2rem" }}>// error</div>
        <h2 style={{ fontFamily: "var(--font-display)", fontSize: "2.8rem", fontWeight: 700, letterSpacing: "-0.03em", margin: "0 0 1.2rem" }}>Something went wrong.</h2>
        <p style={{ fontSize: "1.4rem", color: "var(--ink-60)", lineHeight: 1.6, marginBottom: "2.4rem" }}>
          This docs page could not be rendered. Try reloading — if the problem persists, the server may still be compiling.
        </p>
        <button
